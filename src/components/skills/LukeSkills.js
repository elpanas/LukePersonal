...
const LukeSkills = () => {
  ...
  return (
    <div>      
        ...
        <hr className="my-2" />
          <Row>
          <BoxSkill skillname={skills[0].skillname} skillset={skills[0].skillset} />
          <Col sm="3">
          ...
          <BoxSkill skillname={skills[1].skillname} skillset={skills[1].skillset} />
          <BoxSkill skillname={skills[2].skillname} skillset={skills[2].skillset} />
          </Row>
        </Container>  
        <Tooltip placement="top" isOpen={tooltipNode} target="node" toggle={toggleNode}>Express.js</Tooltip>
        ...
        <Tooltip placement="top" isOpen={tooltipJs} target="js" toggle={toggleJs}>React.js</Tooltip>
